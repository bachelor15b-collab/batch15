...
<head>
    ...
    <title>Saved Videos - Batch15Tube</title>
...
<body>
    ...
    <div style="max-width:1400px;margin:0 auto;">
        <h1 style="font-size:28px;font-weight:700;margin-bottom:24px;"><i class="fas fa-bookmark"></i> Saved Videos</h1>
        <?php if (empty($savedVideos)): ?>
        <div style="text-align:center;padding:60px 20px;color:var(--text-secondary);">
            <i class="fas fa-bookmark" style="font-size:48px;margin-bottom:16px;opacity:0.5;"></i>
            <h2 style="color:var(--text-primary);">No saved videos yet</h2>
